...
class LacsLalurAposInovacoes(dbController):
    ...
    def gerandoTabelas(self,cnpj,ano):
        ...
        jcp = self.get_jcp_value(cnpj,'resultadosjcp',ano,"Valor do JSCP Apropriar")
    ...
    def gerandoTabelasTrimestral(self,cnpj,ano):
        ...
        jcp = self.get_jcp_value_trimestral(cnpj,'resultadosjcptrimestral',ano,"Valor do JSCP Apropriar")
        tabelaFInal = pd.concat([tabelaLacsLalur,jcp]).reset_index(drop='index')
